...
import {
  CarouselBasicDemo,
  CarouselIndicatorsDemo,
  CarouselItemSizeDemo,
  CarouselLabelsDemo,
  CarouselLoopDemo,
} from "./demos";
...
const doc: ComponentContent = {
  ...
  demos: [
    {
      ...
      code: `<Carousel.Root aria-labelledby="guides">
  ...
  <div className="row">
    ...
    },
    {
      ...
      code: `<Carousel.Root labels={{ region: "Guides" }}>
  ...
  <Carousel.Indicators />
    ...
    },
    {
      ...
      code: `<Carousel.Root labels={{ region: "Guides" }} loop>
  <Carousel.Track>…</Carousel.Track>
  <div className="row">
    <Carousel.Previous />
    <Carousel.Next />
  ...
  <Carousel.Indicators />
    ...
    },
    {
      ...
      code: `<Carousel.Root labels={{ region: "Contexts" }} style={{ "--loam-carousel-item-size": "10rem" }}>
  <Carousel.Track>
...
>
      ...
      props: [
        {
          ...
          default: "false",
          description:
            "At either end, Previous and Next wrap around instead of carrying aria-disabled.",
        },
        {
          name: "labels",
          type: "{ region?: string; previous?: string; next?: string; indicator?: (i: number, n: number) => string; status?: (i: number, n: number) => string }",
          default: `{ region: "Carousel", previous: "Previous", next: "Next", indicator: (i, n) => "Go to slide i of n", status: (i, n) => "Slide i of n" }`,
          description:
            "The default strings: the region's name (unless you pass aria-label or aria-labelledby), the buttons' names, each indicator's name and the status read once the track settles. i is 1-based.",
        },
      ],
    },
    {
      ...
      props: [
        {
          ...
          description:
            "Substitute your own element; it receives the wiring (ref, class, children).",
        },
      ],
    },
    {
  ...
  cssProps: [
    {
      name: "--loam-carousel-item-size",
      syntax: "CSS length",
      default: "20rem",
      description:
        "The width every item shares, set on the Root or any ancestor. An item is never wider than the track, so a narrow container still shows one whole item.",
    },
  ],
};
