export const metadata = {
  ...
  description:
    "Install the LoamUI skill, give your agent a first prompt, and review the interface it builds.",
};
...
<PromptBlock prompt="Use the LoamUI skill to build a profile form with name and email fields and a Save changes button." />
...
<PromptBlock prompt="Use the LoamUI skill to set up this project for LoamUI development." />
...
<details>
<summary id="project-setup">What init set up</summary>
...
<PackageCommands name="stylelint" />
...
<span id="establish-the-environment-first" />
...
<span id="the-contract-for-every-implementation" />
